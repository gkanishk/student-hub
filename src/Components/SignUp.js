...
function SignUp(){
    ...
    return (
        <Card style={{minHeight:'90vh'}}>
            ...
            <Form style={{padding:'25px',backgroundColor:'#F8F9FA',borderRadius:'5px',marginTop:'3vh'}} onSubmit={signUp}>
                ...
                <Form.Group controlId="formBasicPhone" >
                    ...
                    <Form.Control type="number" placeholder="Enter phone number" maxLength='10' onChange={e=>setPhone(e.target.value)} />
                </Form.Group>
                <Form.Group controlId="formBasicDOB" >
                    <Form.Label style={{textAlign:'left',width:'100%'}}>Date Of Birth</Form.Label>
                    <Form.Control type="date" placeholder="Enter DOB" onChange={e=>setYear(e.target.value)} />
                </Form.Group>
                ...
                <Form.Group controlId="formBasicMarks" >
                    ...
                    <Form.Control type="text" placeholder="Enter Average Marks Throughout" maxLength='5' onChange={e=>setMarks(e.target.value)} />
                </Form.Group>
                <Form.Group controlId="formBasicPassingYear" >
                    <Form.Label style={{textAlign:'left',width:'100%'}}>Passing Year</Form.Label>
                    <Form.Control type="number" min="1998" max="2030" step="1" maxLength='4' placeholder="Enter Passing Year" onChange={e=>setPYear(e.target.value)} />
                </Form.Group>
                ...
                <Form.Group controlId="formBasicCPassword">
                    ...
                    <Form.Control type="password" placeholder="Password" onChange={e=>setCpass(e.target.value)}/>
                </Form.Group>
